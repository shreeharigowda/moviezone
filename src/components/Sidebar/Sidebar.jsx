    ...
    <>
      <div className={classes.scroll}>
       ...
       src={theme.palette.mode ==='light' ? redLogo :blueLogo}
        alt="Filmpire Logo"
      /> */}
          <Typography fontSize="24px" fontFamily="sans-serif" className={classes.th} fontWeight="bold" style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "5px 5px 5px 5px" }}>MovieZone</Typography>
